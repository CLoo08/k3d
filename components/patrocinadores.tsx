  ...
  return (
    <section className="py-2">
       <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 delay-75 duration-100 ease-in-out" data-aos="fade-up">
            ...
            <div className="mx-auto max-w-3xl py-10 sm:py-10 lg:max-w-none lg:py-5">
                <div className="max-w-4xl mx-auto text-center pb-5 md:pb-5"> {/* Ajusta el ancho del contenedor */}
